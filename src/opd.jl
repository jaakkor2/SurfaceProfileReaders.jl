# Format seems to be partially described in a Matlab script by Veeco
# https://github.com/kranthibalusu/Crystal-plasticity-/blob/master/ProfileAnalysis/ReadOPD.m
...
fn = joinpath(pathof(SurfaceProfileReaders), "..", "..", "test", "demo.opd")
data = readopd(fn)
```
...
```julia
# data to plot
(; x, y, z, colormap, nan_color) = opdprepplot(data)
...
"""
function opdprepplot(data::Dict)
